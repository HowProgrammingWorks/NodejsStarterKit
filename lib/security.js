...
const hashPassword = password => new Promise((resolve, reject) => {
  crypto.randomBytes(SALT_LEN, (err, salt) => {
    ...
    crypto.scrypt(password, salt, KEY_LEN, SCRYPT_PARAMS,
      (err, hash) => {
        if (err) {
          reject(err);
          return;
...
const validatePassword = (password, hash) => new Promise((resolve, reject) => {
...
module.exports = { hashPassword, validatePassword, defaultHash };
